...
kendo.mobile.Application.prototype = {
    ...
    navigate: function(url,transition) {
        ...
        /// <param name="transition" type="String" >The transition to apply when navigating. See [View Transitions section](/getting-started/mobile/application/overview#view-transitions) for more information.</param>
